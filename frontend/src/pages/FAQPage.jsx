...
const FAQ = () => {
  return (
    <div className="overflow-x-hidden max-w-full">
      <div className="bg-[#fefcf8]min-h-screen w-full  text-3xl font-serif font-extrabold flex  ">
        <div className="md:w-2/3 sm:w-5/6 w-10/12 flex flex-col sm:pl-4 py-4">
          ...
          <Questions
            ques="What is Fundsy and how does it work?"
          ...
          />
          <Questions
            ques="What makes Fundsy different from traditional crowdfunding platforms?"
          ...
          />
          <Questions
            ques="How are donations managed?"
